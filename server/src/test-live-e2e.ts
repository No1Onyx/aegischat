...
async function runFullSystemTest() {
  ...
  console.log(`✅ [1/10] Server is online. Architecture: "${statusData.type}"\n`);
  ...
  console.log(`✅ [2/10] Cryptographic key material generated successfully\n`);
  ...
  console.log(`✅ [3/10] Public Key Registration & Ephemeral OPK Popping verified\n`);
  ...
  console.log(`✅ [4/10] Real-time blind relay connections active\n`);
  ...
  console.log(`✅ [5/10] Initial X3DH Handshake & Double Ratchet Message 1 verified\n`);
  ...
  console.log(`✅ [6/10] Forward Secrecy symmetric chain rotation verified\n`);
  ...
  console.log(`✅ [7/10] Diffie-Hellman Ratchet Step & Post-Compromise Security verified\n`);
  ...
  console.log(`✅ [8/10] Zero-Knowledge Untrusted Server guarantee verified\n`);
  ...
  await sleep(1000);
  const grpMsg = bobReceivedMsgs.slice(beforeCount).find((m) => m.groupId === grp.id);
  ...
  console.log('   All 10 security properties passed over the live network.');
  console.log('🎉 =========================================================\n');
}
